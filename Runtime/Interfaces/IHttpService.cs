namespace BaseWithBestHttp.Interfaces
{
    ...
    public interface IHttpService
    {
        ...
        UniTask Download(string address, string filePath, OnDownloadProgressDelegate onDownloadProgress, int timeoutSeconds = 30,
            int retryCount = 3, CancellationToken cancellationToken = default);

        UniTask<byte[]> DownloadAndReadStreaming(string address, OnDownloadProgressDelegate onDownloadProgress, int timeoutSeconds = 30,
            int retryCount = 3, CancellationToken cancellationToken = default);
    ...
    public abstract class BaseHttpRequest
    {
        ...
        public virtual void ErrorProcess(string message) { }

        public virtual void ExceptionProcess(Exception exception) { }
